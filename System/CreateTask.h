...
static UBaseType_t uxHighWaterMark_TaskA; // 任务A的堆栈高水位标记
static UBaseType_t uxHighWaterMark_TaskB; // 任务B的堆栈高水位标记
static UBaseType_t uxHighWaterMark_TaskC; // 任务C的堆栈高水位标记
static UBaseType_t uxHighWaterMark_TaskD; // 任务D的堆栈高水位标记
...
#define Task_A_ERROR "TaskA Stack Low"
#define Task_B_ERROR "TaskB Stack Low"
#define Task_C_ERROR "TaskC Stack Low"
#define Task_D_ERROR "TaskD Stack Low"
